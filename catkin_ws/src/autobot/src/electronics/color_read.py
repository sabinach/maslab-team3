...
# Prints RGB, clear(C), colorTemp, and lux values read and computed from the device. For more details,
# see the Adafruit_TCS34725 Arduino library, from which the colorTemp and lux computations are used.
